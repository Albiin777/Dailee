  ...
  return (
    <section id="home" className="relative flex min-h-[calc(80vh-64px)] flex-col items-center justify-center text-center">
      <div className="max-w-3xl">
        ...
        <p className="mt-6 text-base text-gray-500 dark:text-gray-400 sm:text-lg">
            A quiet space to record your progress, reflect on your journey, and see how far you've come.
        </p>
        <div className="mt-14 flex items-center justify-center sm:mt-10">
          <a
            href="#entry"
        ...
        <div className="mt-10 text-sm font-semibold text-gray-600 dark:text-gray-300 sm:mt-6">
          {formattedDate}
          <div className="text-xs font-medium text-gray-400 dark:text-gray-500">
            {weekday}
          </div>
        </div>
        <div className="mt-12 flex flex-col items-center gap-2 text-[10px] uppercase tracking-[0.3em] text-gray-300 dark:text-gray-600 sm:mt-10">
          <span>Scroll</span>
